...
interface InventoryDao {
    ...
    suspend fun getItemByItemID(itemID: Int): InventoryItem?

    @Query("SELECT inventory.id FROM inventory, items WHERE items.name = :name AND items.id = inventory.itemID")
